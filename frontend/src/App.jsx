...
import PersonalTrainingPage from './PersonalTraining'; // Import the new page
import GroupClassesPage from './GroupClassesPage';  // Import Group Classes page
import NutritionPlansPage from './NutritionPlansPage';  // Import Nutrition Plans page
...
function App() {
  ...
  return (
   ...
   <Route path="/group-classes" element={<GroupClassesPage />} />  {/* Route for Group Classes */}
